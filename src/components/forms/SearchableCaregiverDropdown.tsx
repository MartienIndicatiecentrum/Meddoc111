...
const SearchableCaregiverDropdown: React.FC<
  SearchableCaregiverDropdownProps
> = ({
  caregivers,
  value,
  onChange,
  ...
  const handleKeyDown = (e: React.KeyboardEvent) => {
    ...
    const totalItems =
      ...
      (searchTerm && filteredCaregivers.length === 0 ? 1 : 0);
  ...
  const handleCreateCaregiver = async () => {
    ...
    if (
      newCaregiverData.email &&
      !/\S+@\S+\.\S+/.test(newCaregiverData.email)
    ) {

...
export const ActivityLogger: React.FC<ActivityLoggerProps> = ({
  ...
  useEffect(() => {
    const mockActivities: ActivityLog[] = [
      ...
      },
      {
        ...
        details: {
          description:
            'AI zoekopdracht: "Zoek alle laboratorium uitslagen van deze maand"',
          ip_address: '192.168.1.100',
          user_agent:
            'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36',
        },
  ...
  const exportActivities = () => {
    ...
    link.setAttribute(
      'download',
      `activiteiten_log_${new Date().toISOString().split('T')[0]}.csv`
    );
  ...
  return (
    <div className='space-y-6'>
      <Card
        style={cardWidth ? { width: cardWidth, boxSizing: 'border-box' } : {}}
      >
        <CardHeader>
          ...
          <CardDescription>
            Volledige audit trail van alle acties in het documentmanagement
            systeem
          </CardDescription>
        </CardHeader>
        ...
        <CardContent className='space-y-6'>
            ...
            <Card className='p-4'>
              <div className='flex items-center space-x-2'>
                ...
                <div>
                  ...
                  <p className='text-xl font-bold'>
                    {
                      activities.filter(a => a.action === 'status_change')
                        .length
                    }
                  </p>
                </div>
          ...
          <div className='space-y-4'>
            <div className='flex items-center justify-between mb-4'>
              ...
              >
                {showRecent ? 'Verberg' : 'Toon'} recente activiteiten (
                    ...
                    <div className='flex-1 min-w-0'>
                      <div className='flex items-center justify-between mb-1'>
                        ...
                        <div className='flex items-center space-x-2 text-xs text-gray-500'>
                          ...
                          <span>
                            {activity.timestamp.toLocaleString('nl-NL')}
                          </span>
                        </div>
                      </div>
            ...
            {filteredActivities.length === 0 && showRecent && (
              <div className='text-center py-8'>
                ...
                <p className='text-gray-500'>
                  Geen activiteiten gevonden voor de huidige filters
                </p>
              </div>
            )}
          </div>

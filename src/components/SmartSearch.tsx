    ...
    <div className='space-y-6'>
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Gebruik natural language queries om documenten te vinden met
                        ...
                        <div className='flex items-center space-x-3'>
                          ...
                          <div>
                            ...
                            <p className='text-sm text-gray-600'>
                              ...
                              {result.document.created_at.toLocaleDateString(
                                'nl-NL'
                              )}
                            </p>
                          </div>
                        ...
                        <div className='flex items-center space-x-4 text-sm text-gray-500'>
                          {result.document.deadline && (
                            <div className='flex items-center space-x-1'>
                              ...
                              <span>
                                Deadline:{' '}
                                {result.document.deadline.toLocaleDateString(
                                  'nl-NL'
                                )}
                              </span>
                            </div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4 text-sm'>
              <div>
                ...
                <p className='text-gray-600'>
                  Begrijpt de betekenis van uw vraag en vindt relevante
                  documenten
                </p>
              </div>
              <div>
                <h5 className='font-medium text-gray-800 mb-1'>
                  Cross-document Referenties
                </h5>
                <p className='text-gray-600'>
                  Vindt verbanden tussen verschillende documenten
                </p>
              </div>
              <div>
                <h5 className='font-medium text-gray-800 mb-1'>
                ...
                <p className='text-gray-600'>
                  Genereert relevante samenvattingen van zoekresultaten
                </p>
              </div>
              <div>
                <h5 className='font-medium text-gray-800 mb-1'>
                  Sleutelwoord Extractie
                </h5>
                <p className='text-gray-600'>
                  Identificeert automatisch belangrijke termen
                </p>
              </div>
            </div>
          </div>

...
export const LogboekTableRow = memo<LogboekTableRowProps>(({
  ...
  const statusColor = STATUS_COLORS[entry.status as keyof typeof STATUS_COLORS] || 'bg-gray-100 text-gray-800';
    ...
    >
      <div className="grid grid-cols-12 gap-4 p-4 items-center">
        ...
        <div className="col-span-3">
          <p className="text-sm text-gray-900 truncate" title={sanitizedAction}>
        ...
        {/* Description */}
        <div className="col-span-3">
          <p className="text-sm text-gray-600 truncate" title={sanitizedDescription}>
        ...
        <div className="col-span-1">
          <p className="text-sm text-gray-500">
            {entry.created_at ? format(new Date(entry.created_at), 'dd/MM', { locale: nl }) : '-'}
          </p>
        </div>

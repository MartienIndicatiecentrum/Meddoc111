...
const ClientDocumentsPage = React.lazy(() => import("./pages/ClientDocumentsPage"));
  ...
  if (!clientId) {
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <div className="text-center">
          <h2 className="text-xl font-semibold text-gray-800 mb-2">Geen cliënt geselecteerd</h2>
          <p className="text-gray-600">Selecteer een cliënt om documenten te bekijken.</p>
        </div>
      </div>
    );
  }
    ...
    element: (
      <div className="min-h-screen bg-gray-50 py-8">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-6">
            <h1 className="text-3xl font-bold text-gray-900">Email Reminder Beheer</h1>
            <p className="text-gray-600 mt-2">Beheer en test het email reminder systeem voor afspraken</p>
          </div>
          <EmailReminderAdmin />
        </div>
      </div>

...
export const LogboekFilters: React.FC<LogboekFiltersProps> = ({
  ...
  const [debouncedDescription, setDebouncedDescription] = useState(filterDescription);
    ...
    <div className="space-y-4 mb-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="space-y-2">
          ...
          <Select value={filterType} onValueChange={(value) => handleInputChange('filterType', value)}>
        ...
        <div className="space-y-2">
          ...
          <Select value={filterStatus} onValueChange={(value) => handleInputChange('filterStatus', value)}>
            <SelectTrigger className="h-9">
          ...
          <Popover>
            <PopoverTrigger asChild>
              ...
              >
                ...
                {filterDate ? format(filterDate, 'PPP', { locale: nl }) : 'Selecteer datum'}
              </Button>
            </PopoverTrigger>
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          ...
          <Input
            ...
            onChange={(e) => handleInputChange('filterDescription', e.target.value)}
            className="h-9 pl-10"
          />
        </div>
      </div>

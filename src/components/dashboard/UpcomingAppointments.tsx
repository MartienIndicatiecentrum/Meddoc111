...
const UpcomingAppointments: React.FC<UpcomingAppointmentsProps> = ({ appointments, max = 3 }) => {
  const formatDateTime = (dateString: string) => {
    const date = new Date(dateString);
    return {
      date: date.toLocaleDateString("nl-NL", { day: "2-digit", month: "2-digit", year: "numeric" }),

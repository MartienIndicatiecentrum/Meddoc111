...
export const DocumentViewer: React.FC<DocumentViewerProps> = ({ document, fullscreen }) => {
  ...
  const getPriorityColor = (priority: string) => {
    switch (priority) {
      ...
      case 'laag': return 'bg-gray-100 text-gray-800';
      default: return 'bg-gray-100 text-gray-800';
    }
  };
    ...
    if (document.mime_type === 'application/pdf') {
      ...
      return (
        <img
          src={document.file_path}
          alt={document.title}
          style={{ width: '100vw', height: '100vh', objectFit: 'contain', margin: 0, display: 'block' }}
        />
      );
    } else {
      return (
        <a
          ...
          style={{ display: 'block', width: '100vw', height: '100vh', textAlign: 'center', lineHeight: '100vh' }}
        >
          Download bestand
        </a>
      );
      ...
      <div className="space-y-6">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 gap-2 text-sm text-gray-600">
              <div className="flex items-center space-x-2">
                ...
                <span>Toegevoegd: {document.created_at.toLocaleDateString('nl-NL')}</span>
              </div>
              <div className="flex items-center space-x-2">
              ...
              {document.deadline && (
                <div className="flex items-center space-x-2">
                  ...
                  <span>Deadline: {document.deadline.toLocaleDateString('nl-NL')}</span>
                </div>
              )}
            </div>
          </div>
        ...
        <div className="bg-blue-50 p-4 rounded-lg">
          ...
          <div className="text-sm text-blue-800 space-y-2">
            ...
            <p>• Belangrijke datums gedetecteerd: {document.deadline?.toLocaleDateString('nl-NL')}</p>

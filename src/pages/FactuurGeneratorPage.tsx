      ...
      <div className="max-w-full mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <div className="flex justify-between items-start mb-6">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Factuur Generator</h1>
        ...
        {clientData ? (
              ...
              <Card className="bg-white">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                                              <Label htmlFor="clientNaam" className="text-gray-500">Cliënt Naam</Label>
                      <Input
                        id="clientNaam"
                        value={clientData.naam || ''}
                        onChange={(e) => {
                          setClientData(prev => ({ ...prev, naam: e.target.value }));
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => {
                          ...
                          setClientData(prev => ({ ...prev, geboortedatum: newDate }));
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => {
                          setClientData(prev => ({ ...prev, bsn: e.target.value }));
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        value={clientData.polisnummer || clientData.machtigingsnummer || ''}
                        onChange={(e) => {
                          setClientData(prev => ({ ...prev, polisnummer: e.target.value }));
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <Input
                        id="uzoviCode"
                        value={clientData.uzoviCode || `${getUzoviCode(clientData.verzekeraar)} / ${clientData.verzekeraar}`}
                        onChange={(e) => {
                          setClientData(prev => ({ ...prev, uzoviCode: e.target.value }));
                        }}
                  ...
                  <div>
                    ...
                    <Input
                      id="verzekeraarAdres"
                      value={clientData.verzekeraarAdres || (VERZEKERAAR_ADRESSEN[clientData.verzekeraar]?.adres) || ''}
                      onChange={(e) => {
                        setClientData(prev => ({ ...prev, verzekeraarAdres: e.target.value }));
                      }}
                      placeholder="Wordt automatisch ingevuld bij verzekeraar selectie"
                    />
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        value={clientData.verzekeraarPostcode || (VERZEKERAAR_ADRESSEN[clientData.verzekeraar]?.postcode) || ''}
                        onChange={(e) => {
                          setClientData(prev => ({ ...prev, verzekeraarPostcode: e.target.value }));
                        }}
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        value={clientData.verzekeraarPlaats || (VERZEKERAAR_ADRESSEN[clientData.verzekeraar]?.plaats) || ''}
                        onChange={(e) => {
                          setClientData(prev => ({ ...prev, verzekeraarPlaats: e.target.value }));
                        }}
                        placeholder="Wordt automatisch ingevuld"
                      />
                    </div>
                  ...
                  <div className="border-t pt-4">
                    <h4 className="font-semibold text-gray-900 mb-3">💰 Factuur Instellingen</h4>
                  ...
                  {/* Betaalgegevens */}
                  <div className="border-t pt-4">
                    <h4 className="font-semibold text-gray-900 mb-3">💳 Betaalgegevens</h4>
                  ...
                  {invoiceLines.map((line, index) => (
                    <div key={line.id} className="border border-gray-200 rounded-lg p-4">
                      <div className="flex justify-between items-center mb-3">
                        <h5 className="font-medium text-gray-900">Regel {index + 1}</h5>
                      ...
                      <div className="grid grid-cols-2 gap-4 mb-3">
                        <div>
                          ...
                          <Input
                            ...
                            type="date"
                            value={line.date}
                            onChange={(e) => updateInvoiceLine(line.id, 'date', e.target.value)}
                          />
                        </div>
                        <div>
                          ...
                          <Input
                            ...
                            step="0.5"
                            value={line.hours}
                            onChange={(e) => updateInvoiceLine(line.id, 'hours', e.target.value)}
                          />
                        </div>
                      </div>
                      <div className="grid grid-cols-3 gap-4">
                        <div className="col-span-2">
                          <Label htmlFor={`description-${line.id}`}>Omschrijving</Label>
                          <Input
              ...
              <Card className="bg-white">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <h4 className="font-medium text-blue-900 mb-2">💡 Over de Factuur Generator:</h4>
                    <ul className="text-sm text-blue-800 space-y-1">
                      <li>• Selecteer een cliënt om automatisch factuurgegevens in te vullen</li>
                      <li>• Factuurnummer wordt automatisch gegenereerd</li>
                      <li>• Uzovi-code wordt automatisch toegevoegd op basis van verzekeraar</li>
                      <li>• Voeg meerdere factuurregels toe voor gedetailleerde facturen</li>
              ...
              <CardContent className="space-y-6">
                ...
                <div>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <div className="font-semibold">{clientData.verzekeraar || 'Verzekeraar'}</div>
                    <div>{(VERZEKERAAR_ADRESSEN[clientData.verzekeraar]?.adres) || '-'}</div>
                    <div>{(VERZEKERAAR_ADRESSEN[clientData.verzekeraar]?.postcode) || ''} {(VERZEKERAAR_ADRESSEN[clientData.verzekeraar]?.plaats) || ''}</div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-2 text-sm">
                    <div><span className="font-semibold">Factuurnummer:</span> {invoiceNumber}</div>
                    <div><span className="font-semibold">Factuurdatum:</span> {invoiceDate}</div>
                    <div><span className="font-semibold">Vervaldatum:</span> {dueDate}</div>
                    <div><span className="font-semibold">Uzovi-code:</span> {getUzoviCode(clientData.verzekeraar)} / {clientData.verzekeraar}</div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div><span className="font-semibold">Naam:</span> {clientData.naam}</div>
                    <div><span className="font-semibold">Geboortedatum:</span> {clientData.geboortedatum ? new Date(clientData.geboortedatum).toLocaleDateString('nl-NL') : '-'}</div>
                    <div><span className="font-semibold">BSN:</span> {clientData.bsn || '-'}</div>
                    <div><span className="font-semibold">Polisnummer:</span> {clientData.polisnummer || clientData.machtigingsnummer || '-'}</div>
                  </div>
                </div>
                      ...
                      <div key={line.id} className="bg-gray-50 p-3 rounded-lg">
                        <div className="flex justify-between items-start">
                          <div className="flex-1">
                            <div className="font-medium text-sm">Regel {index + 1}</div>
                            <div className="text-sm text-gray-600">{line.description || 'Geen omschrijving'}</div>
                            <div className="text-xs text-gray-500">
                              {line.date ? new Date(line.date).toLocaleDateString('nl-NL') : 'Geen datum'} • {line.hours} uur • €{line.rate}/uur
                            </div>
                          </div>
                          <div className="font-semibold text-sm">€ {line.total}</div>
                        </div>
                      </div>
                    ))}
                  </div>
                ...
                <div>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg space-y-2 text-sm">
                    <div><span className="font-semibold">IBAN:</span> {iban}</div>
                    <div><span className="font-semibold">Rekeninghouder:</span> {accountHolder}</div>
                    <div><span className="font-semibold">Omschrijving:</span> {paymentDescription}</div>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <Card className="bg-white">
            <CardContent className="p-8 text-center">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">Selecteer een cliënt</h3>
              <p className="text-gray-600 mb-4">
                Kies een cliënt uit de dropdown hierboven om een factuur te genereren.
              </p>
            </CardContent>
          </Card>
        )}

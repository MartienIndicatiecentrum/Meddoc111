...
const DocumentDetailModal: React.FC<DocumentDetailModalProps> = ({
  ...
  console.log('📄 DocumentDetailModal render:', {
    open,
    document,
  ...
  console.log(
    '🎆 Modal WILL RENDER with document:',
    document.title,
    'file_path:',
    document.file_path
  );
            ...
            {document?.file_path ? (
              ...
              >
                <iframe
                  ...
                  onError={e => {
                    ...
                    console.log(
                      'Direct PDF view failed, trying alternative methods...'
                    );
                    ...
                    setTimeout(() => {
                      ...
                      iframe.onerror = () => {
                        console.log(
                          'Google Docs viewer also failed, showing manual link...'
                        );
                        if (container) {
                          container.innerHTML = `
              ...
              <div className='bg-white border-2 border-dashed border-gray-300 rounded p-8 text-center text-gray-500'>
                ...
                <p className='text-sm mb-4'>
                  Het bestandspad is niet beschikbaar voor dit document
                </p>
                <div className='space-y-2 bg-gray-100 p-4 rounded text-xs'>
                  ...
                  <p className='text-gray-400'>
                    Bestandspad: {document.file_path || 'ONTBREEKT'}
                  </p>
                  <p className='text-gray-400'>
                    Client ID: {document.client_id || 'Geen'}
                  </p>
                  {!document.file_path && (
                    <div className='mt-3 p-2 bg-yellow-100 border border-yellow-300 rounded'>
                      <p className='text-yellow-800 text-xs'>
                        ⚠️ Dit document heeft geen file_path - het is mogelijk
                        niet correct geüpload naar Supabase Storage.
                      </p>
                    </div>
                  )}
                </div>
              ...
              >
                <iframe
                  ...
                  onError={e => {
                    ...
                    const container = (e.target as HTMLIFrameElement)
                      .parentElement;
                    if (container) {
                      container.innerHTML = `
              ...
              <div className='bg-white border rounded p-4 font-mono text-sm'>
                <div className='text-gray-500 text-center'>
                  ...
                  <p className='font-sans text-xs mt-2'>
                    Het bestandspad is niet beschikbaar
                  </p>
                </div>
              </div>
            )}
            ...
            {document?.file_path && (
              <div className='space-y-3'>
                <p className='text-sm text-gray-500'>
                  Je kunt het bestand wel downloaden of openen in een nieuwe tab
                </p>
            ...
            <div className='flex items-center gap-3'>
              ...
              <div>
                <h2 className='text-xl font-semibold text-gray-900'>
                  {document?.title || 'Onbekend document'}
                </h2>
              ...
              <div className='space-y-4'>
                ...
                <div className='bg-gray-50 rounded-lg p-4'>
                  <p className='text-gray-700'>
                    Dit document bevat belangrijke medische informatie en moet
                    regelmatig worden gereviewed.
                  </p>
                </div>
              </div>
            </div>

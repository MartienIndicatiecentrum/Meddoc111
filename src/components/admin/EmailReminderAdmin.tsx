    ...
    <div className='bg-white rounded-lg shadow-sm border p-6'>
      ...
      <div className='mb-6'>
        ...
        {status.isRunning && (
          <p className='text-sm text-gray-600'>
            Controleert elke {status.intervalMinutes} minuten op nieuwe
            herinneringen
          </p>
        )}
      ...
      <div className='mt-6 p-4 bg-blue-50 rounded-lg'>
        ...
        <ul className='text-sm text-blue-800 space-y-1'>
          <li>
            • De scheduler controleert automatisch op afspraken die een
            herinnering nodig hebben
          </li>
          <li>
            • Herinneringen worden alleen verzonden voor afspraken met status
            "Gepland"
          </li>
      ...
      <div className='mt-4 p-4 bg-yellow-50 rounded-lg'>
        ...
        <ul className='text-sm text-yellow-800 space-y-1'>
          <li>
            • Zorg ervoor dat de Supabase Edge Function 'send-email' is
            gedeployed
          </li>
          <li>
            • Configureer de RESEND_API_KEY in Supabase omgevingsvariabelen
          </li>
